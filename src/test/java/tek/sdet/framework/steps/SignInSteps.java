...
//		List<List<String>> emailField = dataTable.asLists(String.class);
//		sendText(factory.signInPage().emailField, DataGeneratorUtility.data(emailField.get(0).get(0)));
//		sendText(factory.signInPage().passwordField, DataGeneratorUtility.data(emailField.get(0).get(1)));
    }
